...
'code'
'code' cd ..  // to return back  from the femtoshell directory 
...
# from main directory 
'code' gcc main.c "FemtoShell/femtoshell.c" -o main.exe 

## used commands
'code' vim file : used to edit c files and write the code 
'code' mkdir dir : used to make directory in current directory 
